            ...
            var timeCountDown = {
                ...
                setHtml: function(time){
                    ...
                    if(_startLeftTime > 0){
            			...
            			if(_endLeftTime > 0){
                            $(v).html([
            					'<li class="item"><i class="day">'+_day+'<span>days</span></i></li>',
            					//'<li class="blank">:</li>',
            					'<li class="item"><i class="hour">'+_hour+'<span>hours</span></i></li>',
            					//'<li class="blank">:</li>',
            					'<li class="item"><i class="minute">'+_minite+'<span>minutes</span></i></li>',
            					//'<li class="blank">:</li>',
            					'<li class="item"><i class="second">'+_second+'<span>seconds</span></i></li>'
            					//'<li class="blank">:</li>',
