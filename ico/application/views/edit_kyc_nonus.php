			...
			<div class="animated fadeIn">
			  <div class="dash_kyc">
                  ...
                  <div class="card">
                          ...
                          <div id="pay-invoice">
                                  ...
                                  <div class="card-title">
                                      <h3 class="text-center">KYC For NON U.S. User</h3>
                                  </div>
                              
							<?php							
								$attributes = array('role'=>"form", 'id' => 'u_s', 'method'=>'post');
								$kyc_url = base_url().'edit_nonus';
                ...
                ?>
									  ...
									  <div class="form-group">
                                          <label for="cc-payment" class="control-label mb-1">Government identification number (Optional) </label>
                                          <?php
												$data = array(
															'name'          => 'social_number',
															'id'            => "social_number",
															'placeholder'   => 'Government identification number (Optional)',
															'type'         => 'text',
															'value'       => $kyc['ssn'],
															'class'       => 'form-control  col-xs-10 url-upload link',
