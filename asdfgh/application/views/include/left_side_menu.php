          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
				<li><a href="<?php echo base_url(); ?>Dashboard"><i class="fa fa-th-list" aria-hidden="true"></i>Dashboard</a></li> 
				<li><a href="<?php echo base_url(); ?>user_list"><i class="fa fa-users" aria-hidden="true"></i>User Management</a></li>
				<li><a href="<?php echo base_url(); ?>transaction"><i class="fa fa-clock-o" aria-hidden="true"></i>Transaction Management</a></li>	
