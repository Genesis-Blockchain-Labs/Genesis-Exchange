						...
						<?php echo $this->session->flashdata('success_msg'); ?>
							<div class="ref_admin">
								...
								<?php  $attributes = array('role'=>"form", 'method'=>'post');
										$url = base_url().'register_setup_update';
										echo form_open_multipart($url, $attributes); ?>
										<label>Registration Functionality: </label> 
											<input type="radio" name="register_status" value="1" <?php if($admin_setup['register_status']==1) { ?>checked="checked" <?php } ?>/><span>ON</span>
											<input type="radio" name="register_status" value="0" <?php if($admin_setup['register_status']==0) { ?> checked="checked" <?php } ?>/><span>OFF</span>
