				...
				<div class="x_content">
					...
					<div id="my-tab-content" class="tab-content">			
						<div class="tab-pane active" id="orange">
							<form action="<?php echo base_url(); ?>saveevent" id="add_form" enctype="multipart/form-data" method="post" class="form-horizontal form-label-left">
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">							
										<input type="text" id="eventname" class="form-control col-md-7 col-xs-12" name="eventname" value="<?php echo set_value('eventname');  ?>" autocomplete="off">	
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
										<div class="error-form-dv"><?php echo form_error('eventname');  ?></div>
									</div>
								</div>								
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="tax">Event Link: </label>
									<div class="col-md-6 col-sm-6 col-xs-12">							
										<input type="text" id="eventlink" class="form-control col-md-7 col-xs-12" name="eventlink" value="<?php echo set_value('eventlink');  ?>" autocomplete="off">	
									</div>
								</div> 
								<div class="form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
										<div class="error-form-dv"><?php echo form_error('eventlink');  ?></div>
									</div>
								</div>
								<div class="form-group">
