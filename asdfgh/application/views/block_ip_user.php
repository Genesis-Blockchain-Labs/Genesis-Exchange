			...
			<div class="x_panel">
				<div class="x_title">
					<ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
						<li class="active">Block IP address (For Website Users)</li>
					</ul>
				...
				?>	
					<div id="my-tab-content" class="tab-content">			
						<div class="tab-pane active" id="orange">
							...
							<form action="<?php echo base_url();?>block_ip_user" enctype="multipart/form-data" method="post" class="form-horizontal form-label-left" autocomplete="off">
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">							
										<input type="text" id="ip" class="form-control col-md-7 col-xs-12" name="ip" value="<?php echo set_value('ip');  ?>">	
									</div>
...
function confirmunblock(id){
	...
	if(result){  
		document.location.href="<?php echo base_url('blockip/unblock_ip'); ?>/"+id;
		return true; 
	}else{
		return false;
	}	
...
<script>
    $(document).ready(function () {
        ...
        $('#user_data').DataTable({
            ...
            "serverSide": true,
            "ajax":{
		     "url": "<?php echo base_url('blockip/posts') ?>",
		     "dataType": "json",
		     "type": "POST",
